      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <div className="flex-1 min-w-[200px]">
          <Select
            ...
            onValueChange={(value: string) => handleFiltersChange({ sportType: value })}
          >
            <SelectTrigger>
          ...
          <Popover>
            ...
            <PopoverContent className="w-auto p-0">
              <Calendar
                ...
                onSelect={(date: Date | null) => handleFiltersChange({ date: date || undefined })}
                locale={fr}
                initialFocus
                required={true}
              />
        ...
        <div className="flex-1 min-w-[200px]">
          <Select
            ...
            onValueChange={(value: string) => handleFiltersChange({ sortBy: value })}
          >
            <SelectTrigger>
        ...
        <div className="flex-1 min-w-[200px]">
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-sm">Prix: {filters.priceRange[0]}€ - {filters.priceRange[1]}€</span>
            </div>
            <Slider
              defaultValue={filters.priceRange}
              max={100}
              step={1}
              onValueChange={(value: number[]) => handleFiltersChange({ priceRange: value })}
            />
          </div>
        </div>
